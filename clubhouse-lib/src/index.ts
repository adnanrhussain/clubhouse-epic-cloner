...
class Client<RequestType, ResponseType> {
  ...
  /** */
  listEpics(params?: ListParams): Promise<Array<Epic>> {
    return this.listResource('epics', params);
  }
  ...
  listEpicStories(epicID: ID, params?: ListParams): Promise<Array<Story>> {
    return this.listResource(`epics/${epicID}/stories`, params);
  }
